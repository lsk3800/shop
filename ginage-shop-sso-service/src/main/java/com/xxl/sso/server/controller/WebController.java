...
import com.xxl.sso.server.feign.SSOLoginServiceFeign;
...
public class WebController {
	...
	public String doLogin(HttpServletRequest request, HttpServletResponse response,
		...
		// valid login
		/*
		 * ReturnT<UserInfo> result = userService.findUser(username, password); if
		 ...
		 * request.getParameter(Conf.REDIRECT_URL)); return "redirect:/login"; }
		 */

		UserLoginDTO userLoginDTO = new UserLoginDTO();
		userLoginDTO.setMobile(username);
		userLoginDTO.setPassword(password);
		userLoginDTO.setLoginType(Constants.MEMBER_LOGIN_TYPE_PC);
		BaseResponse<XxlSsoUser> result = ssoLoginServiceFeign.ssoLogin(userLoginDTO);
	...
	public String logout(HttpServletRequest request, HttpServletResponse response,
		...
		String redirect_url = request.getParameter(Conf.REDIRECT_URL);
		redirectAttributes.addAttribute(Conf.REDIRECT_URL, redirect_url);
